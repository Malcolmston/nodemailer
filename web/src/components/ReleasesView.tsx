...
import { NODEMAILER } from '../data';

// Scoped to this repository only: the live release history is read straight from
// the GitHub Releases API for malcolmston/nodemailer.
const RELEASE_LIBS: RelLib[] = [
  { name: NODEMAILER.name, icon: NODEMAILER.icon, accent: NODEMAILER.accent, repo: ghrepo(NODEMAILER), url: NODEMAILER.repo },
];
